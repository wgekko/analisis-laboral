...
st.set_page_config(layout='wide', page_title='Análisis y Predicción - Informalidad Laboral', page_icon=":material/analytics:",initial_sidebar_state="collapsed" )
...
# ------------------ Interfaz Streamlit ------------------
st.title(":material/badge: Análisis y Predicción - Informalidad Laboral (2003-2025)")

st.info("Datos de Asalariados informales según características socio-economicas")
st.info("Datos de Asalariados informales sin planes de empleo - según características socio-economicas")
st.info("Datos tasa de Informalidad Laboral según características socio-economicas")
st.markdown("Carga el Excel. Selecciona categoría y presiona **Analizar categoría seleccionada**.")

# ------------------------------------------------------------
# CARGA AUTOMÁTICA DEL EXCEL
# ------------------------------------------------------------
ruta_base = os.path.join(os.getcwd(), "data", "informalidad laboral")
