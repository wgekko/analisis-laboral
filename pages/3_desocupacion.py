...
st.set_page_config(layout='wide', page_title='Análisis y Predicción - Tasa/Población Desocupada', page_icon=":material/analytics:",initial_sidebar_state="collapsed" )
...
# ------------------ Interfaz Streamlit ------------------
st.title(":material/badge: Análisis y Predicción - Tasa/Población Desocupada (2003-2025)")

st.info("Datos de Población Desocupada según caracterícticas socio-económicas")
st.info("Datos de Población Desocupada con experiencia laboral según caracterícticas socio-económicas")
st.info("Datos de tasa de desocupación según características socio-economicas")
st.info("Datos de tasa de desocupación de los jefes de hogar según características socio-economicas")
st.markdown("Carga el Excel. Selecciona categoría y presiona **Analizar categoría seleccionada**.")

# ------------------------------------------------------------
# CARGA AUTOMÁTICA DEL EXCEL
# ------------------------------------------------------------
ruta_base = os.path.join(os.getcwd(), "data", "desocupacion")
