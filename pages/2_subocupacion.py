...
st.set_page_config(layout='wide', page_title='Análisis y Predicción - Tasa/Población Sub-Ocupada', page_icon=":material/analytics:", initial_sidebar_state="collapsed" )
...
# ------------------ Interfaz Streamlit ------------------
st.title(":material/badge: Análisis y Predicción - Población/Tasa Subocupación (2003-2025) ")

st.info("Datos de Población Subocupada según características socio-economicas")
st.info("Datos  de tasa de Subocupación según características socio-economicas")
st.markdown("Carga el Excel. Selecciona categoría y presiona **Analizar categoría seleccionada**.")

# ------------------------------------------------------------
# CARGA AUTOMÁTICA DEL EXCEL
# ------------------------------------------------------------
ruta_base = os.path.join(os.getcwd(), "data", "subocupacion")
